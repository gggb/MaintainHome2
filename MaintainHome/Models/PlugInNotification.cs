...
namespace MaintainHome.Models
{
    ...
    {
        [PrimaryKey, AutoIncrement] public int NotificationId { get; set; } // Primary key
        [Indexed] public int TaskId { get; set; } // Foreign key to Tasks table
        public string NotificationType { get; set; } // Type of notification (e.g., Notice, Reminder, Overdue, Completion, Cancelation)
